    ...
    <div className="flex flex-col items-center">
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-lg w-full">
        <div className="glass-card p-3 sm:p-4 rounded-2xl text-center border border-rose-500/20">
          ...
          <span className="text-[10px] sm:text-xs text-stone-500/80 tracking-wider uppercase">Days</span>
        </div>
        <div className="glass-card p-3 sm:p-4 rounded-2xl text-center border border-rose-500/20">
          <span className="block font-serif text-2xl sm:text-4xl font-bold gold-gradient-text">
            {String(timeDiff.hours).padStart(2, '0')}
          </span>
          <span className="text-[10px] sm:text-xs text-stone-500/80 tracking-wider uppercase">Hours</span>
        </div>
        <div className="glass-card p-3 sm:p-4 rounded-2xl text-center border border-rose-500/20">
          <span className="block font-serif text-2xl sm:text-4xl font-bold gold-gradient-text">
            {String(timeDiff.minutes).padStart(2, '0')}
          </span>
          <span className="text-[10px] sm:text-xs text-stone-500/80 tracking-wider uppercase">Mins</span>
        </div>
        <div className="glass-card p-3 sm:p-4 rounded-2xl text-center border border-rose-500/20">
          <span className="block font-serif text-2xl sm:text-4xl font-bold gold-gradient-text">
            {String(timeDiff.seconds).padStart(2, '0')}
          </span>
          <span className="text-[10px] sm:text-xs text-stone-500/80 tracking-wider uppercase">Secs</span>
        </div>
      </div>
    </div>
  );
